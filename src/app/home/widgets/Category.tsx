  ...
  return (
    <div className="mt-28 flex flex-col flex-wrap items-center justify-center">
      <div className="h-[550px] lg:h-[440px] relative lg:scale-85 lg:ml-[350px] xl:scale-100 xl:ml-[450px]">
        ...
        <Link href='/shop' className="btn-shopNow top-[520px] lg:top-60 lg:left-[-180px] xl:left-[-210px]">
          SHOP NOW
        </Link>
      </div>
      ...
      <Image src={getImage("/assets/banner/banner4.jpg")} alt="" width={440} height={440}></Image>
        <div className="font-semibold text-[26px] sm:text-[32px] w-full lg:w-[300px] absolute top-[420px] lg:top-[100px] lg:left-[-50px] xl:left-[-170px]">
          Shoes Spring 2025
        </div>
        <Link href='/shop' className="btn-shopNow top-[485px] lg:top-[230px] lg:left-[-50px] xl:left-[-170px]">
          SHOP NOW
        </Link>
      </div>
    </div>
